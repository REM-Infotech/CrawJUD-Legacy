...
from app.interfaces.credentials import CredendialsDict
from app.interfaces.session import SessionDict
...
def credentials() -> Response:
    ...
    """
    try:
        from app.models import Credentials, LicensesUsers
        ...
        return make_response(jsonify(database=credentials), 200)
...
def cadastro() -> Response:
    ...
    try:
        ...
        db: SQLAlchemy = current_app.extensions["sqlalchemy"]
        request_data: MultiDict = request.form or request.data or request.json
