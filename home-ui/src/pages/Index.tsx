  ...
  const features = [
    {
      ...
      description: "Robôs automatizados com Selenium para rotinas jurídicas repetitivas"
    },
    {
      icon: Zap,
      title: "Processamento Assíncrono",
      description: "Celery e Redis para gerenciamento eficiente de tarefas em segundo plano"
    },
    {
      icon: Database,
    ...
    },
    {
      icon: Clock,
      title: "Tempo Real",
      description: "Comunicação instantânea via Socket.IO para atualizações em tempo real"
    },
    {
      icon: FileText,
      title: "API Moderna",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Plataforma modular para automação de rotinas jurídicas, integrando robôs, APIs, 
                tarefas assíncronas e comunicação em tempo real. Escalabilidade e eficiência para 
