...
def test_state_or_client(setup_PropertiesCrawJUD) -> None:
...
def test_isStoped(setup_PropertiesCrawJUD, mocker) -> None:
...
def test_chr_dir(setup_PropertiesCrawJUD) -> None:
...
def test_output_dir_path(setup_PropertiesCrawJUD) -> None:
...
def test_message_error(setup_PropertiesCrawJUD) -> None:
...
def test_graphicMode(setup_PropertiesCrawJUD) -> None:
...
def test_bot_data(setup_PropertiesCrawJUD) -> None:
