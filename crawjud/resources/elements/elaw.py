...
select_advogado_responsavel = "//select[contains(@id, 'comboAdvogadoResponsavelProcesso_input')]"
...
CSS_TABELA_VALORES = "tbody[id='j_id_2z:j_id_32_2e:processoAmountObjetoDt_data']"
...
CSS_TEXTAREA_MOTIVO = 'textarea[id="j_id_2z:j_id_32_2e:j_id_32_2j_7:j_id_32_2j_i"]'
