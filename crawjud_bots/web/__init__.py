...
from crawjud_bots.web.custom import QuartLoginManager as LoginManager
...
objects_config = {
    "development": "crawjud_bots.app.config.DevelopmentConfig",
    "production": "crawjud_bots.app.config.ProductionConfig",
    "testing": "crawjud_bots.app.config.TestingConfig",
}
...
class AppFactory:
    ...
    async def init_extensions(self, app: Quart) -> None:
        ...
        async with app.app_context():
            ...
            tlsm.init_app(
                app,
                content_security_policy=crawjud_bots.app.config["CSP"],
    ...
    async def init_blueprints(self, app: Quart) -> None:
        ...
        """
        from crawjud_bots.web.routes.auth import auth
        from crawjud_bots.web.routes.bot import bot
        from crawjud_bots.web.routes.config import admin, supersu, usr
        from crawjud_bots.web.routes.credentials import cred
        from crawjud_bots.web.routes.dashboard import dash
        from crawjud_bots.web.routes.execution import exe
        from crawjud_bots.web.routes.logs import logsbot
