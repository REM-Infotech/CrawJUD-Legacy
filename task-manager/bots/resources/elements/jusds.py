...
XPATH_CLOSE_MODAL = (
    '//*[@class="modal show d-block"]/div/div/div[1]/button'
)

XPATH_BTN_ENTRA_PROCESSO = (
    '//*[@id="isc_Vtable"]/tbody/tr/td[1]/div/img'
)
...
XPATH_BTN_SALVA_STATUS = (
    '//div[@id="TMAKERGRID6bar"]/i[@id="saveButton"]'
)
