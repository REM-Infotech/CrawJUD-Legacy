...
URL_CONFIRMA_LOGIN = "https://csi.infraero.gov.br/citsmart/pages/smartPortal/smartPortal.load"

XPATH_CAMPO_USERNAME = '//input[@id="user_login"]'
XPATH_CAMPO_SENHA = '//input[@id="password"]'
XPATH_BTN_ENTRAR = '//button[@id="btnEntrar"]'
XPATH_INPUT_NUMERO_CHAMADO = (
    '//input[@id="idSolicitacaoServicoPesquisa"]'
)
XPATH_BTN_BUSCAR = '//*[@id="form"]/div/div/div[1]/div[2]/div[9]/div/button[@name="btnPesquisar"]'
XPATH_TABLE_SOLICITACOES = (
    '//div[@id="tabelaSolicitacoes"]/div/table/tbody'
)
