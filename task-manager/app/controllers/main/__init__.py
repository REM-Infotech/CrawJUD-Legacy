...
from app.controllers.main._master import AbstractCrawJUD
from app.custom.canvas import subtask
from app.custom.task import ContextTask
from app.interfaces.dict.bot import BotData, DictFiles
from app.interfaces.types import DictType as DictType
from app.resources import format_string
from app.utils.storage import Storage
from app.utils.webdriver import DriverBot

if TYPE_CHECKING:
    from bs4.element import PageElement

    from app.interfaces.types import PyNumbers, PyStrings, T
    from app.interfaces.types.webdriver_types import BrowserOptions
...
class CrawJUD(AbstractCrawJUD, ContextTask):
    ...
    def __init__(
        ...
        **kwargs: PyStrings | PyNumbers,
        ...
        add_db_task = subtask("app.save_database")
