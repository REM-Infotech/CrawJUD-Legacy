...
from app.resources import workdir
from app.utils.models.logs import MessageLogDict
...
if TYPE_CHECKING:
    ...
    from app.interfaces.types import ColorsDict, ProcessInfo, T
    from app.utils.webdriver import DriverBot as WebDriver
