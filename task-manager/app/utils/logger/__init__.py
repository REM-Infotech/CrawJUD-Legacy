...
def dict_config(**kwargs: str | int) -> tuple[dict[str, Any], str]:
    ...
    handlers_config = {
        "file_handler": {
            "class": "app.utils.logger.handlers.FileHandler",
            "level": logging.INFO,
            "formatter": "json",
            "filename": "app.log",
            "maxBytes": 1024,
        ...
        "stream_handler": {
            # Configura o handler de stream para saída padrão com formatação colorida
    ...
    config = {
        ...
        "formatters": {
            ...
            "json": {
                "()": "app.utils.logger.handlers.JsonFormatter",
            },
            "color": {
                "()": "app.utils.logger.handlers.ColorFormatter",
