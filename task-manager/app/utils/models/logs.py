...
from app.interfaces.pje import ProcessoJudicialDict as Processo
from app.utils.interfaces import ItemMessageList

if TYPE_CHECKING:
    from app.interfaces.types import P
...
def all_data[T](cls: type[T]) -> Generator[T, Any]:  # pragma: no cover
