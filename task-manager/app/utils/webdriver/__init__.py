...
from app.utils.webdriver._driver import config
from app.utils.webdriver.config.proxy import (
    ContentData,
    Cookie,
    DictHARProxy,
    EntryRequest,
...
if TYPE_CHECKING:
    ...
    from app.interfaces.types import P, T
    from app.interfaces.types.webdriver_types import (
        BrowserOptions,
        ChromeConfig,
        FirefoxConfig,
    )
    from app.utils.webdriver.config.chrome import ChromeOptions
    from app.utils.webdriver.config.firefox import FirefoxOptions
...
class DriverBot(WebDriver):
    ...
    def _pages_generator(self) -> Generator[Page, Any]:
